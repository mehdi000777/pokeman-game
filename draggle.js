...
export class Draggle {
    constructor(game) {
        this.game = game;
        this.image = document.getElementById('draggle');
        this.x = 800;
        this.y = 100;
        this.maxFrame = 4;
    ...
    attack(type, recipient) {
        ...
        document.querySelector('.dialogue').innerHTML = `Draggle use ${type}`;
        ...
        switch (type) {
            ...
            case 'Fireball':
                ...
                this.game.fireball.push(new Fireball(this.game, this.x + this.width / 2, this.y + this.health / 2));
                recipient.health -= 20;
    ...
    faint() {
        document.querySelector('.dialogue').innerHTML = 'Draggle Fainted!';
        gsap.to(this, {
            y: this.y + 20,
            opacity: 0
        })
